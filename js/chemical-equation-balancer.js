...
function doBalance() {
    ...
    try {
        ...
        codeOutElem.appendChild(eqn.toHtml(coefs));
        var bruh = document.getElementById("codeOutput").textContent;
        balancedElem.value = bruh;
    }
    catch (e) {
        balancedElem.value = e.toString();
    }
}
